...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Get a bearer token from the `POST /api/v1/auth/login` endpoint, or generate a your token by visiting your dashboard and clicking <b>Generate API token</b>.',
    ],
